    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PSICOLOGO', 'Psicólogo'), ('USUARIO', 'Usuário')], default='USUARIO', max_length=50)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('cpf', models.CharField(max_length=50)),
                ('gender', models.CharField(choices=[('MASCULINO', 'Masculino'), ('FEMININO', 'Feminino'), ('NAO_INFORMAR', 'Não informar'), ('OUTRO', 'Outro')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco_consulta', models.DecimalField(decimal_places=2, max_digits=8)),
                ('duracao_minutos', models.PositiveIntegerField(default=50)),
                ('especialidade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='contas.especialidade')),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
