...
from .views import dashboard, view_all_psicologs, view_detail_psi, agendar, get_horarios_disponiveis, agenda_paciente_view, consulta_detalhe_paciente, cancelar_consulta_paciente, perfil_paciente, editar_perfil_paciente, historico_consultas_paciente_view
...
urlpatterns = [
    ...
    path('paciente/historico', historico_consultas_paciente_view, name='historico_paciente'),
