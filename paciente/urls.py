...
from .views import dashboard, view_all_psicologs, view_detail_psi, agendar, get_horarios_disponiveis, agenda_paciente_view, consulta_detalhe_paciente, cancelar_consulta_paciente, perfil_paciente
